...
def randomInsert():
    ...
    bluzelleServices.createRecords(
        urlAnswer,
        portAnswer,
        answers['uuidData'],
        answers['quantity'])
...
def fileInsert():
    ...
    bluzelleServices.createRecordsFromFile(
        urlAnswer,
        portAnswer,
        answers['uuidData'],
        answers['filePath'])
...
def dropAll():
    ...
    bluzelleServices.dropAllBluzelle(
        urlAnswer, portAnswer, answers['uuidData'])
